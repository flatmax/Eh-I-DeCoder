...
### Fixed
- **Streaming Content**
  - Normalize newlines in streaming content to fix doubled newlines issue
  - Add table content normalization for consistent rendering

### Changed
- **Dependencies**
  - Pin aider-chat version for reproducible builds
